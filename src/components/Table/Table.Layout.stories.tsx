...
export const FixedHeader: Story = {
  args: { dataSource: members, scroll: { y: 280 }, sticky: true, bordered: true },
};
...
export const Headerless: Story = {
  args: { showHeader: false, bordered: true, title: () => "헤더 없이 데이터만 표시" },
};
...
export const ScrollEventsAndStickyOffsets: Story = {
  render: (args) => <ScrollEventsStory {...args} />,
};
