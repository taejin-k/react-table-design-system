    ...
    options: {
      storySort: (a, b) => {
        const componentRank = (title) => {
          ...
          if (title === "Components/Checkbox") return 5;
          if (title === "Components/Radio") return 6;
          if (title === "Components/Toggle") return 7;
          if (title === "Components/Label") return 8;
          if (title === "Components/ErrorMessage") return 9;
          if (title === "Components/Breadcrumb") return 10;
          if (title === "Components/Input") return 11;
          if (title === "Components/TextArea") return 12;
          if (title === "Components/Tooltip") return 13;
          if (title === "Components/Popover") return 14;
          if (title === "Components/Dropdown") return 15;
          if (title === "Components/Segmented") return 16;
          if (title === "Components/Illustrations") return 17;
          if (title === "Components/Flex") return 18;
          if (title === "Components/Select") return 19;
          if (title === "Components/Table") return 20;
          if (title === "Components/Badge") return 21;
          if (title === "Components/ColorPicker") return 22;
          if (title === "Components/Avatar") return 23;
          if (title === "Components/Image") return 24;
          if (title === "Components/Collapse") return 25;
          if (title === "Components/Message") return 26;
          if (title === "Components/Notification") return 27;
          if (title === "Components/Modal") return 28;
          if (title === "Components/Drawer") return 29;
          if (title === "Components/DatePicker") return 30;
          if (title === "Components/TimePicker") return 31;
          return 32;
        };
